                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <h6 class="card-title" style="margin-left: 21px;">Total total costed = {{$totalCostedAll}}</h6>
                            <h6 class="card-title" style="margin-left: 21px;">Total total payment = {{$totalPaymentAll}}</h6>
