...
<div class="card card-info">
    <div class="card-header">
        <h3 class="card-title">Sessions > Add Session</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <div class="row">
            ...
            <form action="{{route('seances.store')}}" method="POST" enctype="multipart/form-data"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="date" name="date_seance" value="{{old('date_seance')}}" class="form-control"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="time" name="debut_seance" value="{{old('debut_seance')}}" class="form-control"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="time" name="fin_seance" value="{{old('fin_seance')}}" class="form-control"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="program_id" class="form-control">
                                ...
                                <option value="{{$program->id}}">{{$program->nom_program}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
