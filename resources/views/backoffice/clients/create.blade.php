...
<div class="card card-info">
    <div class="card-header">
        <h3 class="card-title">Clients > Add Client</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <div class="row">
            ...
            <form action="{{route('register')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="date" name="date_naissance_client" value="{{old('date_naissance_client')}}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="tel_client" value="{{old('tel_client')}}" class="form-control"
